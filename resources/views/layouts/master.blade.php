              ...
              -->
                ...
                <div class="sidebar-wrapper" id="sidebar-wrapper">
                    <ul class="nav">
                        ...
                        <li class="{{'subAdmins'==request()->path() ? 'active' : ''}}">
                            <a href="/subAdmins">
                                <i class="now-ui-icons design_app"></i>
                                <p>Sub Admins</p>
                            </a>
                        ...
                        <li class="{{'trainers'==request()->path() ? 'active' : ''}}">
                            <a href="/trainers">
                                <i class="now-ui-icons ui-1_bell-53"></i>
                                <p>Trainers</p>
                            </a>
                        </li>
                        <li class="{{'exams'==request()->path() ? 'active' : ''}}">
                            <a href="/exams">
                                <i class="now-ui-icons ui-1_bell-53"></i>
                                <p>Exams</p>
                            </a>
                        ...
                        <li class="{{'wrongs'==request()->path() ? 'active' : ''}}">
                            <a href="/wrongs">
                                <i class="now-ui-icons ui-1_bell-53"></i>
                                <p>Wrongs</p>
                            </a>
                        </li>
                        <li class="{{'revisions'==request()->path() ? 'active' : ''}}">
                            <a href="/revisions">
                                <i class="now-ui-icons ui-1_bell-53"></i>
                                <p>Revisions</p>
                            </a>
