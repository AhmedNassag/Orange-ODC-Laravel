                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form action="/wrong-update/{{$wrong->id}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-11">
                                            <div class="form-group">
                                                <label>Wrong Content</label>
                                                <input type="text" name="wrong_content" class="form-control" placeholder="Enter Content" value="{{$wrong->wrong_content}}">
                                            </div>
                                            <div class="form-group">
