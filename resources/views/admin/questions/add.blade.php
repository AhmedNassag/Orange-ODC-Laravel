                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="question_content" class="form-control" placeholder="Enter Content">
                                </div>
                                <div class="form-group">
                                    <label>Question Answer</label>
                                    <input type="text" name="question_answer" class="form-control" placeholder="Enter Answer">
                                </div>
                                <div class="form-group">
